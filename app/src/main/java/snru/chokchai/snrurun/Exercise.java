...
public class Exercise extends AppCompatActivity {
    ...
    private String[] qusetionStrings,choice1Strings,choice2Strings,choice3Strings,choice4Strings,answerStrings;
    private int timesAnInt = 1,ChooseAnInt,scoreAnInt=0,amount,answerTrue,chooseAnInt;
    ...
    public void clickAnswer(View view) {
        if (checkRadio()) {
            ...
            myAlert.myDialog(this, "ยังไม่ได้เลือกคำตอบ", "โปรดเลือกคำตอบ");
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                amount = jsonArray.length();
                 ...
                 qusetionStrings = new String[jsonArray.length()];
                ...
                for (int i=0;i<jsonArray.length();i++) {
                    ...
                    qusetionStrings[i] = jsonObject.getString("Question");
    ...
    private void changeView(int index) {
        textView.setText(Integer.toString(timesAnInt) + qusetionStrings [index]);
